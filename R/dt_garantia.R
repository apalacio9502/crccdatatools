...
dt_gen_gar_dep_exi<- function(conexion,periodo_analisis=NULL,fecha_analisis=NULL,miembros_analisis=NULL,segmentos_analisis=NULL,seudonimo="REAL"){
...
dt_gen_gar_dep_exi_liq<- function(conexion,periodo_analisis=NULL,fecha_analisis=NULL,miembros_analisis=NULL,segmentos_analisis=NULL,seudonimo="REAL"){
  ...
  # Se covierte el miembros analisis a SQL
  miembros_analisis_sql <- dt_miembros_analisis_sql(miembros_analisis,liquidadores=TRUE)
...
dt_gen_gar_exi_resumen<- function(conexion,periodo_analisis=NULL,fecha_analisis=NULL,miembros_analisis=NULL,segmentos_analisis=NULL,seudonimo="REAL"){
...
dt_gen_gar_ggl_ind_fgc_liq<- function(conexion,periodo_analisis=NULL,fecha_analisis=NULL,miembros_analisis=NULL,segmentos_analisis=NULL,seudonimo="REAL"){
...
dt_gen_lmc_consumo<- function(conexion,periodo_analisis=NULL,fecha_analisis=NULL,miembros_analisis=NULL,seudonimo="REAL"){
  ...
  datos <-  dbGetQuery(conexion , glue("SELECT FECHA,
                                    ...
                                    WHERE {miembros_analisis_sql} AND
                                    FECHA BETWEEN {periodo_analisis_sql[1]} AND {periodo_analisis_sql[2]}"))
